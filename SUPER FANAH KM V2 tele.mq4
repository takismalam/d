...
double G_ibuf_76[];
double G_ibuf_80[];
extern int FasterMovingAverage = 40;
extern int SlowerMovingAverage = 50;
...
extern int BullsPowerPeriod = 750;
extern int BearsPowerPeriod = 750;
...
int start() {
   ...
   for (int Li_4 = 0; Li_4 <= Li_0; Li_4++) {
      ...
      if (Gi_132 == TRUE && Gi_136 == TRUE && Gi_144 == TRUE && Gi_140 == TRUE && Gi_148 == TRUE && Gi_172 != 1) {
         ...
         if (Li_4 <= 2 && (!Gi_176) && Advanced_Alert && Advanced_Key != "") {
            AdvancedAlert(Advanced_Key," BUY 4 MENIT",Symbol(),Period());
            Gi_176 = TRUE;
            Gi_180 = FALSE;
         }
         Gi_172 = 1;
         ...
         if (Gi_152 == TRUE && Gi_156 == TRUE && Gi_164 == TRUE && Gi_160 == TRUE && Gi_168 == FALSE && Gi_172 != 2) {
            ...
            if (Li_4 <= 2 && (!Gi_180) && Advanced_Alert && Advanced_Key != "") {
               AdvancedAlert(Advanced_Key," SELL 4 MENIT",Symbol(),Period());
               Gi_180 = TRUE;
               Gi_176 = FALSE;
            }
            Gi_172 = 2;
